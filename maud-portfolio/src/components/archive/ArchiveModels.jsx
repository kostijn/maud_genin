...
export default function ArchiveGallery({ onBack }) {
  ...
  const allImages = [
    ...
    ...Array.from({ length: 11 }, (_, i) => `./images/ba3/maquette/${i + 1}.webp`),
    // Bachproef Folder (14 images)
    ...Array.from({ length: 14 }, (_, i) => `./images/bachproef/maquette/${i + 1}.webp`),
    // Grieving Folder (8 images)
    ...Array.from({ length: 8 }, (_, i) => `./images/grieving/maquette/${i + 1}.webp`),
    ...Array.from({ length: 3 }, (_, i) => `./images/andere maquette/${i + 1}.webp`),
  ];
