...
export default function UrbanInterventionDetail({ project, onBack }) {
  ...
  const soloBigImages = [
    { id: 'intervention_study', src: './images/urban/intervention_study.png', title: 'Intervention Study' },
  ];
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <header className="mb-24 flex flex-col items-center">
          <span className="text-[12px] uppercase tracking-[0.5em] text-gray-400 block mb-4">
            1st bachelor year {project.year}
          </span>
