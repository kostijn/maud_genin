...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="md:col-span-7 space-y-12 w-full"
      >
        ...
        <div className="space-y-8 max-w-xl">
          ...
          <div className="flex gap-10 pt-4">
            <button
              ...
              className="group text-[10px] uppercase tracking-[0.4em] font-bold border-b border-black/10 pb-1 hover:border-black transition-all bg-transparent border-t-0 border-l-0 border-r-0 cursor-pointer"
            >
              Contact
            </button>
            <a
              ...
              target="_blank"
              className="group text-[10px] uppercase tracking-[0.4em] font-bold border-b border-black/10 pb-1 hover:border-black transition-all"
            >
              Linkedin
            </a>
          </div>
